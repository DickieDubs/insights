...
export function ClientDataTable({
  ...
  if (isLoading) {
    return <LoadingSpinner message="Loading clients..." containerClassName="p-8" />;
  }

  if (!Array.isArray(clients) || clients.length === 0) {
    return <p className="p-8 text-center text-muted-foreground">No clients found. Add a new client to get started.</p>;
  }
